...
Last activity: 2026-08-03 - Completed quick task 260803-9wh: hardened the release CI workflow (readiness steps 8-10) — top-level read-only token scope, 8 SHA-pinned actions, standing no-pull_request_target rule

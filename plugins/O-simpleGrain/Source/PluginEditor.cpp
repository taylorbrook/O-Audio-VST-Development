/*
  ==============================================================================
    ...
    label. The real WebView UI lands in Stage 3.
...
OSimpleGrainAudioProcessorEditor::~OSimpleGrainAudioProcessorEditor() = default;

void OSimpleGrainAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.drawFittedText ("O-simpleGrain",
                      bounds.removeFromTop (bounds.getHeight() / 2),
                      juce::Justification::centredBottom, 1);

    g.setColour (juce::Colours::white.withAlpha (0.7f));
    g.setFont (juce::FontOptions (15.0f));
    g.drawFittedText ("Stage 1 shell - 18 parameters, silent (audio: Stage 2, UI: Stage 3)",

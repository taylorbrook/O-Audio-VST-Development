...
{
public:
    OPolystutterAudioProcessor();
    ~OPolystutterAudioProcessor() override;
    ...
    const juce::String getName() const override { return "O-Polystutter"; }

/*
  ==============================================================================
    ...
    O-Polystutter - Audio Processor Implementation
    Ouaricon Audio
...
juce::AudioProcessorValueTreeState::ParameterLayout OPolystutterAudioProcessor::createParameterLayout()
{
...
OPolystutterAudioProcessor::OPolystutterAudioProcessor()
    ...
    , presetManager(apvts, "O-Polystutter")
{
    // Create all 4 lanes
...
void OPolystutterAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
    // Prepare DSP spec
...
void OPolystutterAudioProcessor::releaseResources()
{
...
bool OPolystutterAudioProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
...
void OPolystutterAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* OPolystutterAudioProcessor::createEditor()
{
    return new OPolystutterAudioProcessorEditor(*this);
}
...
void OPolystutterAudioProcessor::setStateInformation(const void* data, int sizeInBytes)
{
...
// Helper functions
void OPolystutterAudioProcessor::updateBeatSync(const juce::Optional<juce::AudioPlayHead::PositionInfo>& posInfo)
{
...
double OPolystutterAudioProcessor::getSubdivisionSamples(int subdivIndex, double bpm, double sampleRate)
{
...
{
    return new OPolystutterAudioProcessor();
}

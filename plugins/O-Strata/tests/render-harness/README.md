...
| H4 | DSP-01 | Track 1: partials > −40 dB at C2 / C4 / C6 at F = 1 and F = 4 (plus Track 0 / 0.5 diagnostic rows, h1..h6 levels); control Track 0 at F = 8 over {Ellipse, Epitrochoid 7} × {C6, C8} | spread ≤ 2 (**fails by design — see SUMMARY**); control rise ≥ 20 dB |

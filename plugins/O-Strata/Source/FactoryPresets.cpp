...
static RawMap completeBase()
{
    ...
    m["oscAPos"] = 0.0f; m["oscALevel"] = 0.8f;
    ...
    m["oscBPos"] = 0.0f; m["oscBLevel"] = 0.0f;
...
static RawMap padArchetype()
{
    auto m = merge (completeBase(), {
        { "oscAPos", 0.3f }, { "oscAUnison", 5 },
        { "oscADetune", 0.35f }, { "oscAWidth", 0.8f },
        { "oscBLevel", 0.55f }, { "oscBCoarse", -12 },
...
{
    auto m = merge (completeBase(), {
        { "oscAPos", 0.3f }, { "oscAUnison", 1 },
        { "oscAWidth", 0.4f },
        { "oscBLevel", 0.3f }, { "oscBCoarse", 0 },
...
{
    auto m = merge (completeBase(), {
        { "oscAPos", 0.3f }, { "oscAUnison", 2 },
        { "oscADetune", 0.15f },
        { "oscBLevel", 0.4f }, { "oscBCoarse", 0 },
                     ...
                     std::vector<Preset>& out)
{
    ...
    // 1. Refracted Glass — bright supersaw with strata shimmer
    out.push_back (makePreset (apvts, cat, "Refracted Glass", merge (base, {
        { "oscAUnison", 7 }, { "oscADetune", 0.5f },
        { "oscBLevel", 0.5f }, { "oscBUnison", 5 },
        { "filtACutoff", 3200.0f },
        { "reverbMix", 0.55f }, { "reverbSize", 0.85f }
    })));

    // 2. Strata Bloom — FM pad with slow position sweep
    out.push_back (makePreset (apvts, cat, "Strata Bloom", merge (base, {
        { "oscAPos", 0.2f }, { "oscAUnison", 5 },
        { "oscBLevel", 0.45f }, { "oscBCoarse", 12 },
    ...
    out.push_back (makePreset (apvts, cat, "Cathedral Ice", merge (base, {
        { "oscAPos", 0.4f }, { "oscAUnison", 6 },
        { "oscBLevel", 0.55f }, { "oscBPos", 0.3f },
    ...
    out.push_back (makePreset (apvts, cat, "Nebula Drift", merge (base, {
        { "oscAPos", 0.5f }, { "oscAUnison", 6 },
        { "oscBLevel", 0.6f }, { "oscBPos", 0.3f },
        { "filtACutoff", 3500.0f },
    ...
    out.push_back (makePreset (apvts, cat, "Silk Road", merge (base, {
        { "oscAPos", 0.35f }, { "oscAUnison", 5 },
        { "oscBLevel", 0.55f }, { "oscBCoarse", 7 },
        { "filtACutoff", 2800.0f },
    ...
    out.push_back (makePreset (apvts, cat, "Paper Sky", merge (base, {
        { "oscAPos", 0.3f }, { "oscAUnison", 4 },
        { "oscBLevel", 0.35f }, { "oscBCoarse", 12 },
    ...
    out.push_back (makePreset (apvts, cat, "Monument Moss", merge (base, {
        { "oscAPos", 0.4f }, { "oscAUnison", 5 },
        { "oscBLevel", 0.6f }, { "oscBCoarse", 7 },
    ...
    out.push_back (makePreset (apvts, cat, "Glass Curtain", merge (base, {
        { "oscAPos", 0.4f }, { "oscAUnison", 3 },
        { "oscADetune", 0.3f }, { "oscAWidth", 0.85f },
        { "oscBLevel", 0.5f }, { "oscBCoarse", 7 },
        { "oscBUnison", 3 },
    ...
    out.push_back (makePreset (apvts, cat, "Lithium Glow", merge (base, {
        { "oscAPos", 0.55f }, { "oscAUnison", 5 },
        { "oscADetune", 0.4f }, { "oscAWidth", 0.95f },
        { "oscBLevel", 0.55f }, { "oscBCoarse", 0 },
        { "oscBUnison", 5 }, { "oscBDetune", 0.3f },
                       ...
                       std::vector<Preset>& out)
{
    ...
    // 19. Cathedral Furnace — deep strata roar
                      ...
                      std::vector<Preset>& out)
{
    ...
    out.push_back (makePreset (apvts, cat, "Plasma Line", merge (base, {
        { "oscAPos", 0.6f }, { "oscAWarpType", 1 }, { "oscAWarpAmt", 0.5f },
        { "oscBLevel", 0.45f },
    ...
    out.push_back (makePreset (apvts, cat, "Razor Wire", merge (base, {
        { "oscAPos", 0.75f }, { "oscAUnison", 5 }, { "oscADetune", 0.35f },
        { "oscBLevel", 0.4f }, { "oscBPos", 0.5f },
    ...
    out.push_back (makePreset (apvts, cat, "Phantom Vocal", merge (base, {
        { "oscAPos", 0.3f }, { "oscAUnison", 3 },
        { "oscBLevel", 0.5f }, { "oscBPos", 0.6f },
    ...
    out.push_back (makePreset (apvts, cat, "Acid Bite", merge (base, {
        { "oscAUnison", 2 }, { "oscADetune", 0.18f },
        { "oscBLevel", 0.45f }, { "oscBCoarse", 0 },
    ...
    out.push_back (makePreset (apvts, cat, "Static Halo", merge (base, {
        { "oscAPos", 0.5f }, { "oscAUnison", 2 },
        { "oscBLevel", 0.45f }, { "oscBCoarse", 7 },
                     ...
                     std::vector<Preset>& out)
{
    ...
    out.push_back (makePreset (apvts, cat, "Reese Foundation", merge (base, {
        { "oscAUnison", 4 }, { "oscADetune", 0.3f },
        { "oscBLevel", 0.55f }, { "oscBFine", 12.0f },
    ...
    // 11. Iron Wolf — strata spectrum bass
                       ...
                       std::vector<Preset>& out)
{
    ...
    // 20. Spectral Spark — strata spectrum delay tail
                    ...
                    std::vector<Preset>& out)
{
    ...
    out.push_back (makePreset (apvts, cat, "Neon Pulse", merge (base, {
        { "oscAPos", 0.4f }, { "oscAUnison", 4 }, { "oscADetune", 0.25f },
        { "oscBLevel", 0.45f },
    ...
    // 21. Glass Telegraph — strata spectrum delay
                   ...
                   std::vector<Preset>& out)
{
    ...
    out.push_back (makePreset (apvts, cat, "Glitch Storm", merge (base, {
        { "oscAPos", 0.8f }, { "oscAUnison", 6 }, { "oscADetune", 0.6f },
        { "oscBLevel", 0.5f },
    ...
    out.push_back (makePreset (apvts, cat, "Frozen Drift", merge (base, {
        { "oscAPos", 0.5f }, { "oscAUnison", 7 }, { "oscADetune", 0.5f },
        { "oscBLevel", 0.4f },
        { "noiseType", 1 }, { "noiseLevel", 0.15f },
    ...
    // 19. Subspace Echo — strata spectrum ping delay
    out.push_back (makePreset (apvts, cat, "Subspace Echo", merge (base, {
        { "oscAPos", 0.5f }, { "oscAUnison", 3 },
        { "oscBLevel", 0.45f }, { "oscBCoarse", 19 },
        { "filtACutoff", 3000.0f }, { "filtARes", 0.3f },
                           ...
                           std::vector<Preset>& out)
{
    ...
    out.push_back (makePreset (apvts, cat, "Sub Boom", merge (base, {
        { "subLevel", 0.95f }, { "subShape", 0 }, { "subOctave", -1 },
    ...
    out.push_back (makePreset (apvts, cat, "Tom Floor", merge (base, {
        { "subLevel", 0.85f }, { "subShape", 0 }, { "subOctave", -1 },
        { "noiseLevel", 0.05f },

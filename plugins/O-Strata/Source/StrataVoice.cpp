...
StrataVoice::StrataVoice() = default;

void StrataVoice::setAPVTS (juce::AudioProcessorValueTreeState* apvts)
{
    parameters = apvts;
...
void StrataVoice::setTuningEngine (TuningEngine* engine)
{
    tuningEngine = engine;
}

void StrataVoice::setProcessor (OStrataAudioProcessor* proc)
{
    processor = proc;
}

void StrataVoice::prepare (double sampleRate, int /*samplesPerBlock*/)
{
...
void StrataVoice::stopNote (float /*velocity*/, bool allowTailOff)
{
    if (allowTailOff)
    {
        ampEnvelope.noteOff();
...
void StrataVoice::renderNextBlock (juce::AudioBuffer<float>& outputBuffer,
...
void StrataVoice::pitchWheelMoved (int newPitchWheelValue)
{
...
void StrataVoice::controllerMoved (int /*controllerNumber*/, int /*newControllerValue*/)
{

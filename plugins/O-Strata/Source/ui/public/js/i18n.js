...
*/
// ============================================================================
// i18n.js — O-Strata UI labels and hover-help, English, French and Simplified
// Chinese
//
// Forked from O-Prism v1.24.0 on 2026-09-07. Every version cited below (v1.20.0 …
// v1.24.0) and every count is O-Prism's history, not an O-Strata release.
//
...
// dump. All 173 of O-Strata's parameters carry an EMPTY `label` column — 0 %, the
...
//     root. Both are live DSP (PluginProcessor.cpp:889-902, StrataVoice.cpp:131)
...
export const I18N_EXEMPT = [
    ...
    // ── The product name ───────────────────────────────────────────────────
    ['O-STRATA', 'the product name — a product name is never translated'],
    ...
    ...[
        ...
        ['Wind',       'noiseType option (PluginProcessor.cpp:132)'],
        // The four waveform names below were exempt through the wavetable
        // catalogue block until the Stage 1 fork removed it with the library;
        // they are arm-1 options in their own right on the sub and LFO dropdowns.
        ['Sine',       'subShape + lfoNShape option (PluginProcessor.cpp:123,398)'],
        ['Triangle',   'subShape + lfoNShape option (PluginProcessor.cpp:123,398)'],
        ['Saw',        'subShape + lfoNShape option (PluginProcessor.cpp:123,398)'],
        ['Square',     'subShape + lfoNShape option (PluginProcessor.cpp:123,398)'],

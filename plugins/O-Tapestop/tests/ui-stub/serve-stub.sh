...
#
# Unlike O-ReverseDelay's copy of this script, no separate preset-manager.js
# copy step is needed: O-Tapestop vendors the module at
# Source/ui/public/modules/preset-manager.js, which the resource provider
# serves at that same path, so the tree copy below already covers it.
#

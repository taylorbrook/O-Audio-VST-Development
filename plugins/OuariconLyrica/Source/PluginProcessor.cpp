...
OuariconLyricaAudioProcessor::OuariconLyricaAudioProcessor()
    ...
    , presetManager(parameters, "OuariconLyrica")
{
...
{
    // v1.5.0: Use preset manager for state serialization (includes preset name)
...
void OuariconLyricaAudioProcessor::initializeFactoryPresets()
{
    ...
    {
        DBG("[OuariconLyrica] Factory presets already exist, skipping initialization");
        return;
    }
    ...
    DBG("[OuariconLyrica] Initialized " + juce::String(presets.size()) + " factory presets");
}

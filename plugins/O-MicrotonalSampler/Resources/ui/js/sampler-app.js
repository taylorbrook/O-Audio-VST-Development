...
function initializeTipsToggle() {
    ...
    let stored = null;
    try { stored = localStorage.getItem('oms.tipsEnabled'); } catch (e) { stored = null; }
    ...
    btn.addEventListener('click', () => {
        ...
        try { localStorage.setItem('oms.tipsEnabled', String(tipsEnabled)); }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try { initI18n(); setupTooltips(); initializeTipsToggle(); }

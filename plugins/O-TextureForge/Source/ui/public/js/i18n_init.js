...
function initializeTipsToggle() {
    ...
    let stored = null;
    try { stored = localStorage.getItem('otf.tipsEnabled'); } catch (e) { stored = null; }
    ...
    btn.addEventListener('click', () => {
        ...
        try { localStorage.setItem('otf.tipsEnabled', String(tipsEnabled)); }

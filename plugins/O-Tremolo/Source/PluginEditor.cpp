    ...
    webView = std::make_unique<juce::WebBrowserComponent>(
        juce::WebBrowserComponent::Options{}
            ...
            .withNativeFunction("getUiLanguage", [this](auto&, auto complete) {
                complete(juce::var(OuariconTremoloAudioProcessor::languageCode(
            ...
            .withNativeFunction("setUiLanguage", [this](auto& args, auto complete) {
                ...
                if (args.size() > 0)
                    processorRef.uiLanguage.store(
                        OuariconTremoloAudioProcessor::languageIndex(args[0].toString()),
...
OuariconTremoloAudioProcessorEditor::getResource(const juce::String& url)
{
    ...
    // v1.7.0: the label table. EMBEDDED in CMakeLists.txt AND served here, in

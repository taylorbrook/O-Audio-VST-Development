...
// O-ReverseDelay — granular reverse delay (Stage 2 DSP, Phase 2.1: core reverse
// wet path, feedback stage stubbed to 0 until Phase 2.2).
...
private:
    ...
    juce::AudioBuffer<float> fbScratch;    // feedback return (stubbed to silence in Phase 2.1)

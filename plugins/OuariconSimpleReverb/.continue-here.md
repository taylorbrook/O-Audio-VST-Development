...
- plugins/OuariconSimpleReverb/.ideas/parameter-spec.md

**Stage 1:**
- plugins/OuariconSimpleReverb/CMakeLists.txt
- plugins/OuariconSimpleReverb/Source/PluginProcessor.h
- plugins/OuariconSimpleReverb/Source/PluginProcessor.cpp
- plugins/OuariconSimpleReverb/Source/PluginEditor.h
- plugins/OuariconSimpleReverb/Source/PluginEditor.cpp

## Build Artifacts

Build and install command:
```bash
./scripts/build-and-install.sh OuariconSimpleReverb
```

Artifacts will be installed to:
- VST3: ~/Library/Audio/Plug-Ins/VST3/Ouaricon Simple Reverb.vst3
- AU: ~/Library/Audio/Plug-Ins/Components/Ouaricon Simple Reverb.component
- Standalone: build/plugins/OuariconSimpleReverb/OuariconSimpleReverb_artefacts/Release/Standalone/Ouaricon Simple Reverb.app

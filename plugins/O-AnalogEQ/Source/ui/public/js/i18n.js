...
export const LABELS = Object.freeze({
    ...
    'label.band.lf':  { en: { t: 'LF SHELF' }, fr: { t: 'LF PLAT.', reviewed: true } , 'zh-Hans': { t: '低频搁架', reviewed: 'bt' }},
    'label.band.lmf': { en: { t: 'LMF' },      fr: { t: 'LMF', reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '中低频', reviewed: 'bt' }},
    'label.band.hmf': { en: { t: 'HMF' },      fr: { t: 'HMF', reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '中高频', reviewed: 'bt' }},
    'label.band.hf':  { en: { t: 'HF SHELF' }, fr: { t: 'HF PLAT.', reviewed: true } , 'zh-Hans': { t: '高频搁架', reviewed: 'bt' }},
    ...
    'label.analog': { en: { t: 'ANALOG' }, fr: { t: 'ANALOG.', reviewed: true } , 'zh-Hans': { t: '模拟', reviewed: 'bt' }},
    ...
    'aria.savePreset': { en: { t: 'Save preset to file' },
                         fr: { t: 'Enregistrer un préréglage dans un fichier', reviewed: true } , 'zh-Hans': { t: '保存预设到文件', reviewed: 'bt' }},

...
- **The second row costs nothing.** With the popover forced open it occupies **y 226..283, 170 x 57 px — byte-identical in English and French** — inside a 420 x 320 frame, clearing the frame's top by 226 px. The width table this plugin's CHANGELOG already carries is unchanged: the 170 px pin holds both languages. The switch face measures **42.00 x 16.00 px in both languages**: *On* and *Marche* both fit inside the 42 px floor.

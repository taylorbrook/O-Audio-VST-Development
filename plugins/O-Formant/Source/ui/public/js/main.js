...
function initializeTipsToggle() {
    ...
    let stored = null;
    try { stored = localStorage.getItem('ofmt.tipsEnabled'); } catch (e) { stored = null; }
    ...
    btn.addEventListener('click', () => {
        ...
        try { localStorage.setItem('ofmt.tipsEnabled', String(tipsEnabled)); }

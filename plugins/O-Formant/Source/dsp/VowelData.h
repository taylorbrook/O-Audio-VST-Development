...
namespace VowelData
{
    ...
    // 0dB=1.0, -7dB=0.4467, -9dB=0.3548, -11dB=0.2818, -12dB=0.2512,
    // -16dB=0.1585, -18dB=0.1259, -20dB=0.1000, -21dB=0.0891, -22dB=0.0794,
    // -28dB=0.0398, -30dB=0.0316, -32dB=0.0251, -36dB=0.0158, -40dB=0.0100

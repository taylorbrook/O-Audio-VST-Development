...
/*
  ==============================================================================
    ...
    O-simpleSubtractive - Visualization Tap (real-time-safe spectrum + scope +
    ...
    the message thread (editor Timer, 30 Hz — wired in Stage 3). Stage 2 only
    confirms the ring + analyzer build and run; Stage 3 emits to the WebView.

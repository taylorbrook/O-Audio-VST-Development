...
export const LABELS = Object.freeze({
    ...
    'label.presetLoad':  { en: { t: 'Load' }, fr: { t: 'Ouvrir', reviewed: true } , 'zh-Hans': { t: '载入', reviewed: 'bt' }},

    // ── Tab row ─────────────────────────────────────────────────────────────
    'label.tabInstrument': { en: { t: 'Instrument' }, fr: { t: 'Instrument', reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '乐器', reviewed: 'bt' }},
    ...
    'label.cpuWarning': { en: { t: 'estimated bell decay. Long decays with polyphony may cause high CPU usage, distortion, or stuttering.' },
                          fr: { t: 'de décroissance estimée. Les décroissances longues avec polyphonie peuvent provoquer une charge CPU élevée, de la distorsion ou des coupures.', reviewed: true } , 'zh-Hans': { t: '为预计的钟声衰减时长。长衰减配合复音可能导致 CPU 占用过高、失真或卡顿。', reviewed: 'bt' }},

    // ── Instrument tab: Synthesis ───────────────────────────────────────────
    'label.secSynthesis':       { en: { t: 'Synthesis' },           fr: { t: 'Synthèse', reviewed: true } , 'zh-Hans': { t: '合成', reviewed: 'bt' }},
    'label.damping':            { en: { t: 'Damping' },             fr: { t: 'Amortissement', reviewed: true } , 'zh-Hans': { t: '阻尼', reviewed: 'bt' }},
    'label.overtoneBrightness': { en: { t: 'Overtone Brightness' }, fr: { t: 'Brillance harmonique', reviewed: true } , 'zh-Hans': { t: '泛音明亮度', reviewed: 'bt' }},
    'label.acousticBrightness': { en: { t: 'Acoustic Brightness' }, fr: { t: 'Brillance acoustique', reviewed: true } , 'zh-Hans': { t: '声学明亮度', reviewed: 'bt' }},
    'label.material':           { en: { t: 'Material' },            fr: { t: 'Matériau', reviewed: true } , 'zh-Hans': { t: '材质', reviewed: 'bt' }},
    'label.inharmonicity':      { en: { t: 'Inharmonicity' },       fr: { t: 'Inharmonicité', reviewed: true } , 'zh-Hans': { t: '非谐性', reviewed: 'bt' }},
    'label.airAbsorption':      { en: { t: 'Air Absorption' },      fr: { t: 'Absorption air', reviewed: true } , 'zh-Hans': { t: '空气吸收', reviewed: 'bt' }},
    'label.airTime':            { en: { t: 'Air Time' },            fr: { t: 'Durée air', reviewed: true } , 'zh-Hans': { t: '空气时间', reviewed: 'bt' }},
    ...
    'label.bloomSpeed':     { en: { t: 'Bloom Speed' },  fr: { t: 'Vitesse éclosion', reviewed: true } , 'zh-Hans': { t: '绽放速度', reviewed: 'bt' }},
    'label.bloomAmount':    { en: { t: 'Bloom Amount' }, fr: { t: 'Quantité éclosion', reviewed: true } , 'zh-Hans': { t: '绽放量', reviewed: 'bt' }},
    'label.shimmer':        { en: { t: 'Shimmer' },      fr: { t: 'Shimmer', reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '微光', reviewed: 'bt' }},
    'label.bloomFineToggle': { en: { t: 'Bloom Fine Controls (Override Mode)' },
                               fr: { t: 'Réglages fins d’éclosion (mode prioritaire)', reviewed: true } , 'zh-Hans': { t: '绽放精细控制（覆盖模式）', reviewed: 'bt' }},
    'label.bloomFineHint':  { en: { t: 'Per-band control - main sliders disabled when active' },
                              fr: { t: 'Réglage par bande - curseurs principaux désactivés', reviewed: true } , 'zh-Hans': { t: '分频段控制——启用时主滑块将被禁用', reviewed: 'bt' }},
    'label.speedLow':       { en: { t: 'Speed Low' },   fr: { t: 'Vitesse grave', reviewed: true } , 'zh-Hans': { t: '低频速度', reviewed: 'bt' }},
    'label.speedMid':       { en: { t: 'Speed Mid' },   fr: { t: 'Vitesse médium', reviewed: true } , 'zh-Hans': { t: '中频速度', reviewed: 'bt' }},
    'label.speedHigh':      { en: { t: 'Speed High' },  fr: { t: 'Vitesse aigu', reviewed: true } , 'zh-Hans': { t: '高频速度', reviewed: 'bt' }},
    'label.amountLow':      { en: { t: 'Amount Low' },  fr: { t: 'Quantité grave', reviewed: true } , 'zh-Hans': { t: '低频量', reviewed: 'bt' }},
    ...
    'label.sub':         { en: { t: 'Sub' },      fr: { t: 'Sub',      reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '低音', reviewed: 'bt' }},
    'label.oct':         { en: { t: 'Oct' },      fr: { t: 'Oct',      reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '八度', reviewed: 'bt' }},
    'label.spread':      { en: { t: 'Spread' },   fr: { t: 'Étalement', reviewed: true } , 'zh-Hans': { t: '扩散', reviewed: 'bt' }},

    // ── Instrument tab: Onsets ──────────────────────────────────────────────
    'label.secOnsets':    { en: { t: 'Onsets' },        fr: { t: 'Attaques', reviewed: true } , 'zh-Hans': { t: '起振', reviewed: 'bt' }},
    'label.strike':       { en: { t: 'Strike' },        fr: { t: 'Frappe', reviewed: true } , 'zh-Hans': { t: '击奏', reviewed: 'bt' }},
    'label.mallet':       { en: { t: 'Mallet' },        fr: { t: 'Maillet', reviewed: true } , 'zh-Hans': { t: '槌', reviewed: 'bt' }},
    'label.attackAmount': { en: { t: 'Attack Amount' }, fr: { t: 'Quantité attaque', reviewed: true } , 'zh-Hans': { t: '起音量', reviewed: 'bt' }},
    ...
    // not a sameAsEn pair.
    'label.velExp':       { en: { t: 'Exp' }, fr: { t: 'Exp.', reviewed: true } , 'zh-Hans': { t: '指数', reviewed: 'bt' }},
    'label.velLog':       { en: { t: 'Log' }, fr: { t: 'Log.', reviewed: true } , 'zh-Hans': { t: '对数', reviewed: 'bt' }},

    // ── Instrument tab: Advanced ────────────────────────────────────────────
    'label.secAdvanced': { en: { t: 'Advanced' },     fr: { t: 'Avancé', reviewed: true } , 'zh-Hans': { t: '进阶', reviewed: 'bt' }},
    'label.partialTune': { en: { t: 'Partial Tune' }, fr: { t: 'Accord des partiels', reviewed: true } , 'zh-Hans': { t: '分音调音', reviewed: 'bt' }},
    'label.pitchEnv':    { en: { t: 'Pitch Env' },    fr: { t: 'Env. hauteur', reviewed: true } , 'zh-Hans': { t: '音高包络', reviewed: 'bt' }},
    ...
    'label.pEnvTime':    { en: { t: 'P.Env Time' },   fr: { t: 'Durée env.', reviewed: true } , 'zh-Hans': { t: '音高包络时间', reviewed: 'bt' }},
    'label.nonlinear':   { en: { t: 'Nonlinear' },    fr: { t: 'Non linéaire', reviewed: true } , 'zh-Hans': { t: '非线性', reviewed: 'bt' }},

    // ── Instrument tab: Multi-Stage Envelope ────────────────────────────────
    'label.secEnvelope':  { en: { t: 'Multi-Stage Envelope' }, fr: { t: 'Enveloppe multi-étages', reviewed: true } , 'zh-Hans': { t: '多段包络', reviewed: 'bt' }},
    'label.envelopeHint': { en: { t: 'Controls how different frequencies decay over time' },
                            fr: { t: 'Règle la décroissance des différentes fréquences dans le temps', reviewed: true } , 'zh-Hans': { t: '控制不同频率随时间衰减的方式', reviewed: 'bt' }},
    'label.strikeTime':   { en: { t: 'Strike Time' }, fr: { t: 'Durée frappe', reviewed: true } , 'zh-Hans': { t: '击奏时间', reviewed: 'bt' }},
    'label.brilliance':   { en: { t: 'Brilliance' },  fr: { t: 'Brillance', reviewed: true } , 'zh-Hans': { t: '亮泽', reviewed: 'bt' }},
    'label.bodyTime':     { en: { t: 'Body Time' },   fr: { t: 'Durée corps', reviewed: true } , 'zh-Hans': { t: '共鸣体时间', reviewed: 'bt' }},
    'label.humSustain':   { en: { t: 'Hum Sustain' }, fr: { t: 'Maintien bourdon', reviewed: true } , 'zh-Hans': { t: '嗡鸣延音', reviewed: 'bt' }},

    // ── Instrument tab: Filter / Performance / Output ───────────────────────
    'label.secFilter':      { en: { t: 'Filter' },    fr: { t: 'Filtre', reviewed: true } , 'zh-Hans': { t: '滤波器', reviewed: 'bt' }},
    'label.lpFilter':       { en: { t: 'LP Filter' }, fr: { t: 'Filtre PB', reviewed: true } , 'zh-Hans': { t: '低通滤波器', reviewed: 'bt' }},
    'label.cutoff':         { en: { t: 'Cutoff' },    fr: { t: 'Coupure', reviewed: true } , 'zh-Hans': { t: '截止', reviewed: 'bt' }},
    'label.secPerformance': { en: { t: 'Performance' }, fr: { t: 'Performance', reviewed: true, sameAsEn: true } , 'zh-Hans': { t: '性能', reviewed: 'bt' }},
    'label.highFidelity':   { en: { t: 'High Fidelity' }, fr: { t: 'Haute fidélité', reviewed: true } , 'zh-Hans': { t: '高保真', reviewed: 'bt' }},
    ...
    'label.keyboardHelp': { en: { t: 'Click or use Z-M, Q-P keys' },
                            fr: { t: 'Cliquer ou utiliser les touches Z-M, Q-P', reviewed: true } , 'zh-Hans': { t: '点击，或使用 Z-M、Q-P 键', reviewed: 'bt' }},
    ...
    'label.intervalsHeader': { en: { t: 'Intervals: {n}' }, fr: { t: 'Intervalles : {n}', reviewed: true } , 'zh-Hans': { t: '音程：{n}', reviewed: 'bt' }},
    ...
    'alt.snail':            { en: { t: 'Snail' }, fr: { t: 'Escargot', reviewed: true } , 'zh-Hans': { t: '蜗牛', reviewed: 'bt' }},

...
export const LABELS = Object.freeze({
    ...
    'label.loopStart': { en: { t: 'Loop Start' }, fr: { t: 'Début de boucle', reviewed: false } },
    'label.loopEnd':   { en: { t: 'Loop End' },   fr: { t: 'Fin de boucle', reviewed: false } },
    'label.loopXf':    { en: { t: 'Loop XF' },    fr: { t: 'Fondu de boucle', reviewed: false } },
    'label.loopMode':  { en: { t: 'Loop Mode' },  fr: { t: 'Mode de boucle', reviewed: false } },
    ...
    'label.fine':      { en: { t: 'Fine' },       fr: { t: 'Affinage',
                                                    ...
                                                    reviewed: false } },
    'label.pitchMode': { en: { t: 'Pitch Mode' }, fr: { t: 'Mode de hauteur', reviewed: false } },
    ...
    'label.pitchStretch': {
        ...
        fr: { t: 'Stretch — durée conservée, hauteur indépendante', reviewed: false },
    },

...
//
// Copied verbatim from O-GrainScatter/Source/dsp/LagrangeInterpolation.h.
// Stateless + random-access — exactly correct for grains reading arbitrary
// source positions (the stateful juce::LagrangeInterpolator streaming class is
// unsuitable for random access; see Stage 2 RESEARCH §8).

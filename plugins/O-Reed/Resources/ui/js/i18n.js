...
export const LABELS = Object.freeze({
    ...
    'label.xy.axisX': {
     ...
     'zh-Hans': { t: '管体特性', reviewed: 'bt' }},
    'label.xy.axisY': {
        en: { t: 'Double Reed' },
        fr: { t: 'Anche double', reviewed: true },
     'zh-Hans': { t: '双簧', reviewed: 'bt' }},
    ...
    'label.xy.boreKey': { en: { t: 'Bore:' }, fr: { t: 'Perce :', reviewed: true } , 'zh-Hans': { t: '管体：', reviewed: 'bt' }},
    'label.xy.reedKey': { en: { t: 'Reed:' }, fr: { t: 'Anche :', reviewed: true } , 'zh-Hans': { t: '簧片：', reviewed: 'bt' }},
    ...
    'label.section.primary': {
     ...
     'zh-Hans': { t: '主要控制', reviewed: 'bt' }},
    'label.section.bore': {
        en: { t: 'Bore & Resonance' },
        fr: { t: 'Perce et résonance', reviewed: true },
     'zh-Hans': { t: '管体与共鸣', reviewed: 'bt' }},
    ...
    'label.section.boreViz': {
     ...
     'zh-Hans': { t: '管体可视化', reviewed: 'bt' }},
    'label.section.reed': { en: { t: 'Reed' }, fr: { t: 'Anche', reviewed: true } , 'zh-Hans': { t: '簧片', reviewed: 'bt' }},
    ...
    'label.section.soundDesign': {
     ...
     'zh-Hans': { t: '声音设计', reviewed: 'bt' }},
    'label.section.voice': { en: { t: 'Voice' }, fr: { t: 'Voix', reviewed: true } , 'zh-Hans': { t: '声部', reviewed: 'bt' }},
    ...
    'label.knob.breath': { en: { t: 'Breath' }, fr: { t: 'Souffle', reviewed: true } , 'zh-Hans': { t: '气息', reviewed: 'bt' }},
    ...
    'label.knob.reedHard': { en: { t: 'Reed Hard.' }, fr: { t: 'Dureté', reviewed: true } , 'zh-Hans': { t: '簧片硬度', reviewed: 'bt' }},

    'label.knob.output': { en: { t: 'Output' }, fr: { t: 'Sortie', reviewed: true } , 'zh-Hans': { t: '输出', reviewed: 'bt' }},

    'label.knob.character': { en: { t: 'Character' }, fr: { t: 'Caractère', reviewed: true } , 'zh-Hans': { t: '特性', reviewed: 'bt' }},
    'label.knob.diameter':  { en: { t: 'Diameter' },  fr: { t: 'Diamètre',  reviewed: true } , 'zh-Hans': { t: '直径', reviewed: 'bt' }},
    ...
    // is the size.
    'label.knob.bellSize': { en: { t: 'Bell Size' }, fr: { t: 'Pavillon', reviewed: true } , 'zh-Hans': { t: '钟体尺寸', reviewed: 'bt' }},

    'label.knob.length': { en: { t: 'Length' }, fr: { t: 'Longueur', reviewed: true } , 'zh-Hans': { t: '长度', reviewed: 'bt' }},

    // toneHoleCutoff, 200-8000 Hz. "les trous de jeu" are a woodwind's finger
    // holes; the readout beside it carries the Hz.
    'label.knob.toneHole': { en: { t: 'Tone Hole' }, fr: { t: 'Trous de jeu', reviewed: true } , 'zh-Hans': { t: '音孔', reviewed: 'bt' }},

    'label.knob.register': { en: { t: 'Register' }, fr: { t: 'Registre', reviewed: true } , 'zh-Hans': { t: '泛音孔', reviewed: 'bt' }},
    ...
    'label.knob.opening': { en: { t: 'Opening' }, fr: { t: 'Ouvert.', reviewed: true } , 'zh-Hans': { t: '开口', reviewed: 'bt' }},
    'label.knob.mass':    { en: { t: 'Mass' },    fr: { t: 'Masse',     reviewed: true } , 'zh-Hans': { t: '质量', reviewed: 'bt' }},
    'label.knob.damping': { en: { t: 'Damping' }, fr: { t: 'Amort.',    reviewed: true } , 'zh-Hans': { t: '阻尼', reviewed: 'bt' }},
    ...
    'label.knob.mouthpiece': { en: { t: 'Mouthpiece' }, fr: { t: 'Bec', reviewed: true } , 'zh-Hans': { t: '吹口', reviewed: 'bt' }},
    ...
    'label.knob.chiff': { en: { t: 'Chiff' }, fr: { t: 'Attaque', reviewed: true } , 'zh-Hans': { t: '起音气声', reviewed: 'bt' }},

    'label.knob.airNoise': { en: { t: 'Air Noise' }, fr: { t: 'Bruit d’air', reviewed: true } , 'zh-Hans': { t: '气噪', reviewed: 'bt' }},
    ...
    'label.knob.revBore':    { en: { t: 'Rev. Bore' },    fr: { t: 'Perce inv.', reviewed: true } , 'zh-Hans': { t: '反向管体', reviewed: 'bt' }},
    'label.knob.feedback':   { en: { t: 'Feedback' },     fr: { t: 'Réinjection', reviewed: true } , 'zh-Hans': { t: '反馈', reviewed: 'bt' }},

    // dronePitch, -2400..2400 cents. "un bourdon" IS a drone; the readout beside
    // it carries the cents.
    'label.knob.dronePitch': { en: { t: 'Drone Pitch' }, fr: { t: 'Bourdon', reviewed: true } , 'zh-Hans': { t: '持续音音高', reviewed: 'bt' }},

    'label.knob.maxVoices': { en: { t: 'Max Voices' }, fr: { t: 'Voix max', reviewed: true } , 'zh-Hans': { t: '最大复音数', reviewed: 'bt' }},
    ...
    'label.boreViz.placeholder': {
     ...
     'zh-Hans': { t: '管体横截面可视化（即将推出）', reviewed: 'bt' }},
    'label.fx.title': {
        en: { t: 'Coming Soon' },
        fr: { t: 'Bientôt disponible', reviewed: true },
     'zh-Hans': { t: '即将推出', reviewed: 'bt' }},
    'label.fx.body': {
     ...
     'zh-Hans': { t: '效果处理将在后续更新中加入。', reviewed: 'bt' }},

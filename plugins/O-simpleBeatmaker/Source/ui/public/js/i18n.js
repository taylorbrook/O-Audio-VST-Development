...
*/
// ============================================================================
// i18n.js — O-simpleBeatmaker interface copy, English + French (v1.2.0)
//
...
export const I18N = Object.freeze({
    ...
    // switch. Through v1.1.1 this plugin's help layer was always on and the
    // panel held the selector alone; the switch is the one O-simpleGrain
    // carries, and its copy is that plugin's, verbatim.
    'gear-btn': {
        en: { t: "Settings",
              b: "Choose the language of the interface and switch this hover help off or on. The language is remembered with the session, so a project reopens in the language you left it in; the help switch is remembered on this computer." },
        fr: { t: "Réglages",
...
export const LABELS = Object.freeze({
    ...
    'label.subtitle': {
        ...
        'zh-Hans': { t: '步进音序鼓机 · 编写一段节奏，然后看力度、摇摆、量化与人性化如何重塑它 · 实地指南', reviewed: 'bt' },
    },
    ...
    'label.freeRun': {
        ...
        'zh-Hans': { t: '● 自由', reviewed: 'bt' },
    },
    'label.synced': {
        en: { t: "● synced" },
        fr: { t: "● synchro", reviewed: true },
        'zh-Hans': { t: '● 已同步', reviewed: 'bt' },
    },
    ...
    'label.gridHintA': {
        ...
        'zh-Hans': { t: '点击一个格子点亮一步；再次点击可循环', reviewed: 'bt' },
    },
    'label.gridHintEm': {
        en: { t: "normal → accent → ghost" },
        fr: { t: "normal → accent → fantôme", reviewed: true },
        'zh-Hans': { t: '普通 → 重音 → 幽灵音', reviewed: 'bt' },
    },
    'label.gridHintB': {
        en: { t: "; right-click (or" },
    ...
    'label.gridHintC': {
        ...
        'zh-Hans': { t: '）清除 · 横向扫过的光条是播放头', reviewed: 'bt' },
    },
    'label.clearAll': {
        en: { t: "Clear all" },
        fr: { t: "Tout effacer", reviewed: true },
        'zh-Hans': { t: '全部清除', reviewed: 'bt' },
    },
    ...
    'label.laneCaption': {
        ...
        'zh-Hans': { t: '节奏位置 / 律动轨道 ·', reviewed: 'bt' },
    },
    'label.laneHint': {
    ...
    'label.midiCaption': {
        ...
        'zh-Hans': { t: 'MIDI 实时读数 ·', reviewed: 'bt' },
    },
    'label.midiHint': {
        ...
        'zh-Hans': { t: '各步触发时的 note-on 消息 —— 网格和这个列表是同一条 MIDI 流的两个视图', reviewed: 'bt' },
    },
    ...
    'label.mute': {
        ...
        'zh-Hans': { t: '静音', reviewed: 'bt' },
    },
    'label.solo': {
        en: { t: "Solo" },
        fr: { t: "Solo", sameAsEn: true, reviewed: true },
        'zh-Hans': { t: '独奏', reviewed: 'bt' },
    },
    ...
    'label.tourSoon': {
        ...
        'zh-Hans': { t: '（点击其中一个 —— 每个都单独呈现一个概念）', reviewed: 'bt' },
    },
    'label.tourCaption': {
        ...
        'zh-Hans': { t: '悬停任意控件即可看到通俗解释 · 点击一个教学预设来加载它，然后转动一个旋钮。', reviewed: 'bt' },
    },
    ...
    'label.tourLoaded': {
        ...
        'zh-Hans': { t: '“{name}”已加载 —— 转动一个旋钮来听这个概念。', reviewed: 'bt' },
    },

...
Validation runs fresh each time (no caching layer).
...
5. Write updates to: `.claude/agent-memory/validation-agent.md`

Memory file path: `.claude/agent-memory/validation-agent.md`
</persistent_memory>

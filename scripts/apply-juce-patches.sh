...
HEADER_FILE="$JUCE_DIR/modules/juce_audio_processors_headless/utilities/juce_VST3ClientExtensions.h"
...
echo -e "  grep -rn \"$MARKER\" $JUCE_DIR/modules/juce_audio_processors_headless/utilities/ $JUCE_DIR/modules/juce_audio_plugin_client/"
